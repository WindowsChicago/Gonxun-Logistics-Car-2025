...
#强光蓝色色块
#color_thr = [(0, 60, 41, 5, 0, 65),(20, 57, -62, -10, -3, 18),(0, 61, 0, 52, -16, -43),(100,255)]
#蓝色折中版色块
...
#仅蓝色最新阈值（若全域值红绿出问题就用这个）
#color_thr = [(0, 60, 41, 5, 0, 65),(20, 57, -62, -13, 3, 31),(0, 61, 0, 52, -23, -62),(100,255)]
